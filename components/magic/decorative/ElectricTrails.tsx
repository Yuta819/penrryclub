...
export function ElectricTrails() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(createTrail, 300); // Create a new trail every 300ms
      ...
      <svg width="0" height="0">
        <defs>
          <linearGradient
            ...
            y2="100%"
          >
            <stop offset="0%" stopColor="#4B0082" /> {/* Dark purple */}
            <stop offset="50%" stopColor="#8A2BE2" /> {/* Medium purple */}
            <stop offset="100%" stopColor="#E6E6FA" /> {/* Light purple */}
          </linearGradient>
        </defs>
      </svg>
    </div>
